    ...
    <div class="lower-section">
      <div class="left-part">
        ...
        <div class="text-box" style="width:680px">
          智能评分：
          <el-input type="number" v-model="submission.systemScore"></el-input>
          智能评语：
      ...
      <div class="right-part">
        ...
        <div class="input-section">
          <div>
            评分：<el-input type="number" v-model="mineScore"></el-input>
          </div>
          <div>
            评语：<el-input type="textarea" v-model="mineEvaluation"></el-input>
          </div>
        </div>
        <!-- 按钮区域 -->
        <div class="button-group">
          <el-button type="success" @click="submitReview">确定</el-button>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    submitReview() {
      this.$emit('submit-review', {
        ...
        mineEvaluation: this.mineEvaluation
      });
      this.$emit('go-back');
    }
  }
