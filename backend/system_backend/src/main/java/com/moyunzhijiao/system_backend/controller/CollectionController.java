...
import com.moyunzhijiao.system_backend.controller.dto.CollectionDTO;
import com.moyunzhijiao.system_backend.entiy.Collection;
import com.moyunzhijiao.system_backend.service.CollectionService;
...
public class CollectionController {
    ...
    public Result updateCollection(@RequestHeader("token") String token,@RequestBody CollectionDTO collectionDTO){
        ...
        collectionDTO.setImporter(userService.getNameById(userId));
