...
import com.moyunzhijiao.system_backend.entiy.word.*;
...
public class SystemTemplateService extends ServiceImpl<SystemTemplateMapper, SystemTemplate> {
    ...
    * */
    ...
    public void addSpecialTemplate(SystemTemplateDTO systemTemplateDTO, Integer userId) {
        ...
        List<String> templateUrls = gatherImagesOfSpecial(imagePaths);
        //批量保存图片
        systemTemplateImageService.addBatch(templateUrls,systemTemplate.getId());
    }
    ...
    * */
    ...
    public void addComprehensiveTemplate(SystemTemplateDTO systemTemplateDTO, Integer userId) {
        ...
        //接着生成图片
        List<String> urlList = gatherImagesOfComprehensive(systemTemplateDTO.getIdArray(),systemTemplateDTO.getComposing());
        //批量保存图片
        systemTemplateImageService.addBatch(urlList,systemTemplate.getId());
    }
