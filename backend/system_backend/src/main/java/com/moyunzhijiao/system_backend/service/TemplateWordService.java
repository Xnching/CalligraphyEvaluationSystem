...
public class TemplateWordService extends ServiceImpl<TemplateWordMapper, TemplateWord> {
    ...
    public IPage<TemplateWord> selectPage(IPage<TemplateWord> page, String str, Integer structureId, Integer radicalId, Integer gradeId, Integer fontId, String importer) {
        QueryWrapper<TemplateWord> queryWrapper = new QueryWrapper<>();
