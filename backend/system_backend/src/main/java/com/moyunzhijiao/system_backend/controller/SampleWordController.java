...
import com.moyunzhijiao.system_backend.service.SampleWordService;
    ...
    public Result singleAddWord(@RequestPart("sampleWord") String sampleWordStr,@RequestPart("file") MultipartFile file){
        if (!file.isEmpty()) {
            ...
            try {
                ...
                sampleWord.setContent(tempPath);
        ...
        for (MultipartFile image : images) {
            if (!image.isEmpty()) {
                ...
                try {
                    ...
                    SampleWord sampleWord = sampleWordService.findSampleWordByFileName(sampleWords, fileName);
