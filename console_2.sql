...
create table school(
    ...
    max_region_id int unsigned not null comment '省份id',
    next_region_id int unsigned not null comment '市级id',
...
create table custom_template(
    ...
    usage_frequency int default 0 comment '使用次数',
    created_time datetime DEFAULT CURRENT_TIMESTAMP comment'创建时间'
)comment '自定义模板';
#已更改上表font
...
create table radical (
    ...
    count int not null comment '笔画数',
    updated_time datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP  comment'更新时间'
)comment '部首';


INSERT INTO radical (name, count) VALUES
('丨', 1), ('亅', 1), ('丿', 1), ('乛', 1), ('一', 1), ('乙', 1), ('乚', 1), ('丶', 1),
('八', 2), ('勹', 2), ('匕', 2), ('冫', 2), ('卜', 2), ('厂', 2), ('刀', 2), ('刂', 2), ('儿', 2), ('二', 2), ('匚', 2), ('阝', 2), ('丷', 2), ('几', 2), ('卩', 2), ('冂', 2), ('力', 2), ('冖', 2), ('凵', 2), ('人', 2), ('亻', 2), ('入', 2), ('十', 2), ('厶', 2), ('亠', 2), ('匸', 2), ('讠', 2), ('廴', 2), ('又', 2),
('艹', 3), ('屮', 3), ('彳', 3), ('巛', 3), ('川', 3), ('辶', 3), ('寸', 3), ('大', 3), ('飞', 3), ('干', 3), ('工', 3), ('弓', 3), ('廾', 3), ('广', 3), ('己', 3), ('彐', 3), ('彑', 3), ('巾', 3), ('口', 3), ('马', 3), ('门', 3), ('宀', 3), ('女', 3), ('犭', 3), ('山', 3), ('彡', 3), ('尸', 3), ('饣', 3), ('士', 3), ('扌', 3), ('氵', 3), ('纟', 3), ('巳', 3), ('土', 3), ('囗', 3), ('兀', 3), ('夕', 3), ('小', 3), ('忄', 3), ('幺', 3), ('弋', 3), ('尢', 3), ('夂', 3), ('子', 3),
('贝', 4), ('比', 4), ('灬', 4), ('长', 4), ('车', 4), ('歹', 4), ('斗', 4), ('厄', 4), ('方', 4), ('风', 4), ('父', 4), ('戈', 4), ('卝', 4), ('户', 4), ('火', 4), ('旡', 4), ('见', 4), ('斤', 4), ('耂', 4), ('毛', 4), ('木', 4), ('肀', 4), ('牛', 4), ('牜', 4), ('爿', 4), ('片', 4), ('攴', 4), ('攵', 4), ('气', 4), ('欠', 4), ('犬', 4), ('日', 4), ('氏', 4), ('礻', 4), ('手', 4), ('殳', 4), ('水', 4), ('瓦', 4), ('尣', 4), ('王', 4), ('韦', 4), ('文', 4), ('毋', 4), ('心', 4), ('牙', 4), ('爻', 4), ('曰', 4), ('月', 4), ('爫', 4), ('支', 4), ('止', 4), ('爪', 4),
('白', 5), ('癶', 5), ('歺', 5), ('甘', 5), ('瓜', 5), ('禾', 5), ('钅', 5), ('立', 5), ('龙', 5), ('矛', 5), ('皿', 5), ('母', 5), ('目', 5), ('疒', 5), ('鸟', 5), ('皮', 5), ('生', 5), ('石', 5), ('矢', 5), ('示', 5), ('罒', 5), ('田', 5), ('玄', 5), ('穴', 5), ('疋', 5), ('业', 5), ('衤', 5), ('用', 5), ('玉', 5),
('耒', 6), ('艸', 6), ('臣', 6), ('虫', 6), ('而', 6), ('耳', 6), ('缶', 6), ('艮', 6), ('虍', 6), ('臼', 6), ('米', 6), ('齐', 6), ('肉', 6), ('色', 6), ('舌', 6), ('覀', 6), ('页', 6), ('先', 6), ('行', 6), ('血', 6), ('羊', 6), ('聿', 6), ('至', 6), ('舟', 6), ('衣', 6), ('竹', 6), ('自', 6), ('羽', 6), ('糸', 6), ('糹', 6),
('貝', 7), ('采', 7), ('镸', 7), ('车', 7), ('辰', 7), ('赤', 7), ('辵', 7), ('豆', 7), ('谷', 7), ('见', 7), ('角', 7), ('克', 7), ('里', 7), ('卤', 7), ('麦', 7), ('身', 7), ('豕', 7), ('辛', 7), ('言', 7), ('邑', 7), ('酉', 7), ('豸', 7), ('走', 7), ('足', 7),
('青', 8), ('靑', 8), ('雨', 8), ('齿', 8), ('长', 8), ('非', 8), ('阜', 8), ('金', 8), ('釒', 8), ('隶', 8), ('门', 8), ('靣', 8), ('飠', 8), ('鱼', 8), ('隹', 8),
('风', 9), ('革', 9), ('骨', 9), ('鬼', 9), ('韭', 9), ('面', 9), ('首', 9), ('韋', 9), ('香', 9), ('页', 9), ('音', 9),
('髟', 10), ('鬯', 10), ('鬥', 10), ('高', 10), ('鬲', 10), ('马', 10),
('黄', 11), ('鹵', 11), ('鹿', 11), ('麻', 11), ('麦', 11), ('鸟', 11), ('鱼', 11),
('鼎', 12), ('黑', 12), ('黽', 12), ('黍', 12), ('黹', 12),
('鼓', 13), ('鼠', 13),
('鼻', 14), ('齊', 14),
('齿', 15), ('龍', 15), ('龠', 15);
...
create table template_word(
    ...
    font_id int UNSIGNED not null comment '字体id',
    radical_id int UNSIGNED not null comment '部首id',
...
create table announcement(
    ...
    target enum('学生','教师','全体') comment '发布对象',
